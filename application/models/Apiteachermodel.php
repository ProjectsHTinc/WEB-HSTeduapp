...
//#################### list Class teacher All hwork ####################//
	public function listCsteacherAllhwork ($class_id)
	{
			$year_id = $this->getYear();
    		...
    		$hw_result = $result->result();
				...
				if($hw_result) {
					$response = array("status" => "success", "msg" => "View All Days Homework", "hwDates"=>$hw_result);
				} else {
					$response = array("status" => "error");
				}
...
//#################### list Class teacher All hwork for days ####################//
	public function listAllhworkday ($class_id,$hw_date)
	{
			$year_id = $this->getYear();
    		...
    		$hw_result = $result->result();
				...
				if($hw_result) {
					$response = array("status" => "success", "msg" => "View All Days Homework", "hwdayDetails"=>$hw_result);
				} else {
					$response = array("status" => "error");
				}
